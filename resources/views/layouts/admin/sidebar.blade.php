...
<aside class="page-sidebar">
    <div class="main-sidebar" id="main-sidebar">
        <ul class="sidebar-menu" id="simple-bar">
            ...
            <li class="sidebar-list">
                <a class="sidebar-link" href="{{ route('dashboard.device.index') }}">
                    <i class="fa-solid fa-desktop"></i>
                    <h6 class="f-w-600">Devices</h6>
                </a>
            </li>
            <li class="sidebar-list">
                <a class="sidebar-link" href="{{ route('dashboard.banner.index') }}">
                    <i class="fa-solid fa-image"></i>
                    <h6 class="f-w-600">Banners</h6>
                </a>
            </li>
            <li class="sidebar-list">
                <a class="sidebar-link" href="{{ route('dashboard.voucher.index') }}">
