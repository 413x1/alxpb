@php use App\Helpers\General; @endphp
    <!-- Page sidebar start-->
<aside class="page-sidebar">
    <div class="main-sidebar" id="main-sidebar">
        <ul class="sidebar-menu" id="simple-bar">
            <li class="sidebar-list {{ General::isActiveRoute('dashboard.index') }}">
                <a class="sidebar-link" href="{{ route('dashboard.index') }}">
                    <i class="fa-solid fa-gauge"></i>
                    <h6 class="f-w-600">Dashboards</h6>
                </a>
            </li>
            <li class="sidebar-list {{ General::isActiveRoute('dashboard.devices.*') }}">
                <a class="sidebar-link" href="{{ route('dashboard.devices.index') }}">
                    <i class="fa-solid fa-desktop"></i>
                    <h6 class="f-w-600">Devices</h6>
                </a>
            </li>
            <li class="sidebar-list {{ General::isActiveRoute('dashboard.banners.*') }}">
                <a class="sidebar-link" href="{{ route('dashboard.banners.index') }}">
                    <i class="fa-solid fa-image"></i>
                    <h6 class="f-w-600">Banners</h6>
                </a>
            </li>
            <li class="sidebar-list {{ General::isActiveRoute('dashboard.vouchers.*') }}">
                <a class="sidebar-link" href="{{ route('dashboard.vouchers.index') }}">
                    <i class="fa-solid fa-tags"></i>
                    <h6 class="f-w-600">Vouchers</h6>
                </a>
            </li>
            <li class="sidebar-list {{ General::isActiveRoute('dashboard.products.*') }}">
            ...
            <li class="sidebar-list {{ General::isActiveRoute('dashboard.orders.*') }}">
            ...
            <li class="sidebar-list {{ General::isActiveRoute('dashboard.users.*') }}">
